...
xmlhttp.open("POST","cproceso.php",true);
...
<br>
     <table border="2">
	 <tr>
	<td><font face="Lubalin Graph" size="4">Numero de Escuela:</font>Obligatorio</td> 
	<td colspan="10"><input  type="text" name="ne" size="45"/></td>
	</tr>
	<tr>
	<td><font face="Lubalin Graph" size="4">Escuela:</font></td>
	...
	<td colspan="10"><textarea name="obs" rows="10" cols="35" ></textarea></td>
	 </tr>
