...
<div class="arriba">
<h1 align="center"><u> <font color="white" face="Lubalin Graph">Modificar Producto</font> </u></h1>
</div> 
...
if(isset($_POST["btn1"])){
	...
	if($btn=="Buscar"){
		...
		$cantidad=$_POST["txtcan"];
		$pcompra=$_POST["txtpc"];
		$porcentaje=$_POST["txtpor"];
		$porgana=($pcompra*$porcentaje)/100;
	
		$pventa=$porgana+$pcompra;
...
<td><input type="text" name="txtprod" size="80" value="<?php echo $var1?>"/>Modificable</td>
</tr>
<tr>
<td> <font face="Lubalin Graph" size="4">  Cantidad de Producto </font></td>
...
<td><input type="text" name="txtpc" style="text-align:right" size="80"  value="<?php echo $var3?>"/>Modificable</td>
</tr>
<tr>
<td> <font face="Lubalin Graph" size="4"> Precio de Venta </font></td>
<td><input type="text" readonly="readonly" style="text-align:right" size="80"  value="<?php echo $var4?>"/></td>
</tr>
<tr>
<td>  <font face="Lubalin Graph" size="4">Porcentaje de Ganancia </font></td>
<td><input type="text" name="txtpor" size="80" value="<?php echo $var5?>"/>Modificable</td>
</tr>
