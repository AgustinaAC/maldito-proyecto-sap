...
if(!$conec){
   ...
   mysql_select_db("meditorial"); //conecta con la base de datos
	$result=mysql_query("select * from clientes where nume like '$nom2'");
	
	if(mysql_fetch_array($result)){
		mysql_query("delete from clientes where nume='$nom2' "); // borra el registro completo que coincida con la condición
